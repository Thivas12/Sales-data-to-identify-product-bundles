df = read.csv('https://github.com/Thivas12/Sales-data-to-identify-product-bundles/blob/d3841104fce408dc521a439a695204b307d39e24/Sales_Dataset.csv')

data = read.csv('https://github.com/Thivas12/Sales-data-to-identify-product-bundles/blob/50ea9aca74a65b89cdc485711be66a2f35bd8bdd/Sales_Transactions_Dataset.csv',header = T,sep = ',')
...
#Net Step: Re-run all the scripts for the raw columns
#raw dataset
r_df1 = df[,2:53]
names(r_df1)
#normalized dataset
